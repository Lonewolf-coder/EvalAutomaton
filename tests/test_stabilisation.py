...
@pytest.mark.asyncio
async def test_submit_stub_has_all_required_fields(tmp_path):
    ...
    try:
        ...
        # Mock the background evaluation to avoid actual execution
        with patch("src.governiq.candidate.routes._run_evaluation_background") as mock_bg:
